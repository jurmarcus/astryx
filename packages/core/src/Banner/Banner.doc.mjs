...
export const docsZh = {
  ...
  features: [
    ...
    '状态颜色：info 使用 --color-accent-deemphasized，warning 使用 --color-warning-deemphasized，error 使用 --color-negative-deemphasized，success 使用 --color-positive-deemphasized',
