import{af as b,ah as q,a6 as w,ay as N,a1 as e}from"./iframe-fBpDkZ7d.js";import{S as r}from"./Stack-CuP4i1jU.js";import{s as W}from"./stackItem.stylex-CgqrJM4N.js";import"./preload-helper-Ct5FWWRu.js";import"./stack.stylex-BlarxY2N.js";function i({crossAlignSelf:s,size:o,as:j="div",xstyle:u,className:v,style:f,children:A,ref:z,...I}){const C=b(...W({crossAlignSelf:s,size:o}),u);return q.createElement(j,{ref:z,...w(N("stack-item",{size:o}),C,v,f),...I},A)}i.displayName="StackItem";i.__docgenInfo={description:`Stack item component for controlling individual item behavior within a stack.
...
Uses a wide container so the spacing differences are clearly visible.`,...a.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  render: () => <div {...stylex.props(styles.storyWrapper)}>
      <div>
...
}`,...c.parameters?.docs?.source},description:{story:`Cross-axis alignment for horizontal stacks (vAlign → align-items).
Uses items with different heights so alignment differences are visible.`,...c.parameters?.docs?.description}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
