const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./iframe-fBpDkZ7d.js","./preload-helper-Ct5FWWRu.js","./iframe-uwqI97oc.css"])))=>i.map(i=>d[i]);
import{_ as V}from"./preload-helper-Ct5FWWRu.js";import{ah as c,a6 as z,ay as H,a1 as u,T as P,a7 as U}from"./iframe-fBpDkZ7d.js";const k=c.lazy(async()=>V(()=>import("./iframe-fBpDkZ7d.js").then(e=>e.j),__vite__mapDeps([0,1,2]),import.meta.url).then(e=>({default:e.Tooltip}))),p=60,f=3600,o=86400,y=30*o,h=365*o,Y=7*o,W=30;function Z(e){return typeof e=="number"?new Date(e<1e12?e*1e3:e):new Date(e)}function C(e,i){const a=Math.round((i.getTime()-e.getTime())/1e3);if(Math.abs(a)<10)return"now";if(a<0){const t=Math.abs(a);if(t<=W)return"now";if(t<p)return"in a few seconds";if(t<f){const n=Math.round(t/p);return`in ${n} ${n===1?"minute":"minutes"}`}if(t<o){const n=Math.round(t/f);return`in ${n} ${n===1?"hour":"hours"}`}if(t<y){const n=Math.round(t/o);return`in ${n} ${n===1?"day":"days"}`}if(t<h){const n=Math.round(t/y);return`in ${n} ${n===1?"month":"months"}`}const r=Math.round(t/h);return`in ${r} ${r===1?"year":"years"}`}if(a<p)return`${a} seconds ago`;if(a<f){const t=Math.round(a/p);return`${t} ${t===1?"minute":"minutes"} ago`}if(a<o){const t=Math.round(a/f);return`${t} ${t===1?"hour":"hours"} ago`}if(a<2*o)return"yesterday";if(a<y)return`${Math.round(a/o)} days ago`;if(a<h){const t=Math.round(a/y);return`${t} ${t===1?"month":"months"} ago`}const s=Math.round(a/h);return`${s} ${s===1?"year":"years"} ago`}function l(e){return String(e).padStart(2,"0")}function X(e,i,a){switch(i){case"date":return new Intl.DateTimeFormat(void 0,{year:"numeric",month:"short",day:"numeric"}).format(e);case"date_time":return new Intl.DateTimeFormat(void 0,{year:"numeric",month:"short",day:"numeric",hour:"numeric",minute:"2-digit",...a?{timeZoneName:"short"}:{}}).format(e);case"time":return new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"2-digit",...a?{timeZoneName:"short"}:{}}).format(e);case"system_date":{const s=e.getFullYear(),t=l(e.getMonth()+1),r=l(e.getDate());return`${s}-${t}-${r}`}case"system_date_time":{const s=e.getFullYear(),t=l(e.getMonth()+1),r=l(e.getDate()),n=l(e.getHours()),v=l(e.getMinutes()),g=l(e.getSeconds());return`${s}-${t}-${r} ${n}:${v}:${g}`}case"system_time":{const s=l(e.getHours()),t=l(e.getMinutes()),r=l(e.getSeconds());return`${s}:${t}:${r}`}}}function B(e){return new Intl.DateTimeFormat(void 0,{year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"2-digit",second:"2-digit",timeZoneName:"short"}).format(e)}function K(e){const i=Math.abs(e);return i<p?1e3:i<f?3e4:i<o?6e4:3e5}function G(e){return e!=="relative"&&e!=="auto"}function $({value:e,format:i="auto",autoThreshold:a=Y,hasTooltip:s=!0,isTimezoneShown:t=!1,isLive:r=!1,type:n="supporting",size:v,color:g="secondary",weight:M,xstyle:S,className:D,style:R,ref:E,"data-testid":q}){const x=c.useRef(null),[_,I]=c.useState(()=>new Date),d=Z(e),F=d.toISOString(),T=Math.round((_.getTime()-d.getTime())/1e3),m=i==="auto"?Math.abs(T)<=a?"relative":"date_time":i,A=m==="relative"?C(d,_):G(m)?X(d,m,t):"",b=B(d);c.useEffect(()=>{if(!r||m!=="relative")return;const N=K(T),L=setInterval(()=>{I(new Date)},N);return()=>clearInterval(L)},[r,m,T]);const O=s&&m==="relative",j=z(H("timestamp",{format:m}),{className:D,style:R}),w=u.jsx(P,{type:n,size:v,color:g,weight:M,xstyle:S,...j,children:u.jsx("time",{ref:U(E,x),dateTime:F,"aria-label":m==="relative"?b:void 0,"data-testid":q,className:"astryxt0psk2 astryxjb2p0i astryx1j61x8r astryx1qlqyl8 astryx15bjb6t astryx1heor9g astryx1pd3egz",children:A})});return O?u.jsxs(u.Fragment,{children:[w,u.jsx(c.Suspense,{fallback:null,children:u.jsx(k,{anchorRef:x,content:b,placement:"above"})})]}):w}$.displayName="Timestamp";$.__docgenInfo={description:`Displays a formatted timestamp as human-readable text.
